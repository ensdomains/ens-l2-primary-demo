...
>({
  ...
  TFunctionName,
  QueryDependencyType
>): CreateQueryKey<TParams, TFunctionName, QueryDependencyType> {
  if (queryDependencyType === "independent")
    return [
      ...
      scopeKey,
      functionName,
    ] as const satisfies CreateQueryKey<TParams, TFunctionName, "independent">;
  ...
  return [
    ...
    scopeKey,
    functionName,
  ] as const satisfies CreateQueryKey<TParams, TFunctionName, "standard">;
}
...
export function useQueryOptions<
  ...
  TIsEnsConfig extends TConfig extends { _isEns: true }
    ? true
    : false = TConfig extends {
    _isEns: true;
  }
    ? true
    : false,
...
>({
  ...
  queryDependencyType,
  queryFn,
}: QueryKeyConfig<TParams, TFunctionName, QueryDependencyType> & {
  queryFn?: TQueryFn;
}) {
