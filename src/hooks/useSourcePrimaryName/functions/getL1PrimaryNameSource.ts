...
type GetL1PrimaryNameSourceFn = (ns: 'addr' | 'default') => UseSourcePrimaryNameFn

export const getL1PrimaryNameSource: GetL1PrimaryNameSourceFn = (ns) => (config) => async(params) => {
